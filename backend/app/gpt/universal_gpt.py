...
from app.utils.output_paths import checkpoint_json_path
...
class UniversalGPT(GPT):
    def __init__(self, client, model: str, temperature: float = 0.7):
        ...
        self.link = False
        # Keep requests well below common gateway body limits to avoid 413s on OpenAI-compatible proxies.
        self.max_request_bytes = int(os.getenv("OPENAI_MAX_REQUEST_BYTES", str(2 * 1024 * 1024)))
    ...
    def _checkpoint_path(self, checkpoint_key: str) -> Path:
        ...
        return checkpoint_json_path(safe_key)
    ...
    def _load_checkpoint(self, checkpoint_key: str, source_signature: str):
