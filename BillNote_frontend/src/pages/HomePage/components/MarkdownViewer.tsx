...
const MarkdownViewer: FC<MarkdownViewerProps> = memo(({ status }) => {
  ...
  return (
    <div className="flex h-screen w-full flex-col overflow-hidden">
      ...
      {viewMode === 'map' ? (
        <div className="flex w-full flex-1 overflow-hidden rounded-[28px] bg-gradient-to-b from-white to-slate-50/80">
        ...
        <div className="flex flex-1 overflow-hidden rounded-b-[24px] bg-gradient-to-b from-white to-slate-50/70 py-2">
          {selectedContent && selectedContent !== 'loading' && selectedContent !== 'empty' ? (
            <>
              ...
              <ScrollArea className="min-w-0 flex-1">
                ...
                <div className={'markdown-body w-full px-2.5 pb-5'}>
                  <ReactMarkdown
            ...
            <div className="flex h-full w-full items-center justify-center px-6">
              <div className="w-[320px] rounded-3xl border border-white/70 bg-white/85 p-8 text-center shadow-[0_20px_60px_rgba(15,23,42,0.08)] backdrop-blur">
                ...
                <p className="mb-2 text-sm font-medium text-slate-700">输入视频链接并点击“生成笔记”</p>
                <p className="text-xs text-slate-500">支持哔哩哔哩、YouTube 等视频网站，也支持批量与本地视频。</p>
              </div>
            </div>
          )}
        </div>
